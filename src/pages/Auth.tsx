...
export default function Auth() {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (error) {
      setIsLoading(false);
      toast({ title: 'Error', description: 'Error al iniciar sesión con Google', variant: 'destructive' });
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background to-muted p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center space-y-4">
          ...
          <CardTitle className="text-2xl font-bold">Link&Play Artists</CardTitle>
          <CardDescription>Gestiona tu carrera artística</CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="register">
              <form onSubmit={registerForm.handleSubmit(handleRegister)} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="register-tipo">Tipo de usuario *</Label>
                  <Select
                    onValueChange={(value: 'venue' | 'artista' | 'representante') =>
                      registerForm.setValue('tipo_usuario', value)
                    }
                  >
                    <SelectTrigger>
                  ...
                  {registerForm.formState.errors.tipo_usuario && (
                    <p className="text-sm text-destructive">{registerForm.formState.errors.tipo_usuario.message}</p>
                  )}
                </div>
                <div className="space-y-2">
